<template>
  <div class="pb-24 -mt-4 sm:mt-10 flex flex-col items-center space-y-4">
    ...
    <div class="space-y-4 text-lg mx-auto max-w-2xl">
      ...
      <h3 class="font-serif text-xl">Topics</h3>
      <ul class="text-base space-y-2">
        <li v-for="(topic, i) in episode.topics" v-bind:key="i">
          <span v-text="topic.timestamp" class="font-mono underline cursor-pointer" v-on:click="seek(topic.secondsToSeek)"></span>
          <span v-text="topic.title"></span>
        </li>
      </ul>
      <h3 class="font-serif text-xl">References</h3>
